...
export declare function createColorBuffer<N extends CosmosInputNode, L extends CosmosInputLink>(data: GraphData<N, L>, reglInstance: regl.Regl, textureSize: number, colorAccessor: ColorAccessor<N>): regl.Framebuffer2D | undefined;
